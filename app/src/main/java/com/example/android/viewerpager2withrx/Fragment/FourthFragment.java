...
public class FourthFragment extends Fragment {
    private List<BaseModel> roadtrip = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        roadtrip = getArguments() != null ? getArguments().getParcelableArrayList("roadtrip") : null;
        System.out.println(roadtrip);

        recyclerView = rootView.findViewById(R.id.recycler_view);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerAdapter = new RecyclerViewAdapter(rootView.getContext(),roadtrip);
